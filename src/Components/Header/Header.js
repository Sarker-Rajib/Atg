                ...
                <Modal.Body className='p-5'>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <button className="sos-button"><img src={f} alt="f" /> Sign up with Facebook</button>
                            <button className="sos-button"><img src={g} alt="m" /> Sign up with Google</button>
                        </div>
                        <div className="col-md-6">
                            <img src={login} alt="imas" className="img-fluid" />
